...
from UNetSEG.Models.Components import Q_CBR_ECA, D_BRC, BRC, BilinearInterpolation, D_CBR, UAttentionGate, ECABlock

class UPPAR34A(nn.Module):

    model_name = "UPPAR34A"

    def __init__(self, in_channels=3, num_classes=2, layer=6, reveal=False, reveal_class=1) -> None:
        super(UPPAR34A, self).__init__()
        ...
        # 拼接输出
        self.out_dcbr = D_CBR((len(self.features) - 1) * num_classes, num_classes)
