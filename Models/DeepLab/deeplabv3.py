...
from UNetSEG.Models.DeepLab.base.oprations import ASPP_module
from UNetSEG.Models.DeepLab.base.resnet import *
...
class DeepLabV3(DeeplabV3):

    model_name = "DeepLabV3"

    def __init__(self, n_class, output_stride=16, pretrained=False):
        if output_stride == 16:
            pyramids = [1, 6, 12, 18]
            grids = [1, 2, 4]
        elif output_stride == 8:
        ...
        super(DeepLabV3, self).__init__(n_class=n_class, block=Bottleneck, layers=[3, 4, 23, 3], pyramids= pyramids,
                                        grids=grids, output_stride=output_stride)
        


if __name__ == '__main__':
    model = resnet101(n_class=2, output_stride=16, pretrained=False)

    img = torch.randn(4, 3, 431, 525)
